...
public class ReservarClaseUseCase {
        ...
        @Transactional
        public Reserva execute(ClaseCommand command) {
                ...
                if (!socio.estaActivo()) {
                        throw new IllegalStateException(
                                        "El socio " + socio.getNombre() + " está SUSPENDIDO hasta "
                                                        + socio.getSuspendidoHasta());
                }
                ...
                if (reservasHoy >= MAX_RESERVAS_POR_DIA) {
                        throw new IllegalStateException(
                                        "Límite de " + MAX_RESERVAS_POR_DIA
                                                        + " reservas diarias alcanzado para el socio " + socioId);
                }
