...
public class ClaseGrupal {
    ...
    public ClaseGrupal(String claseId, String nombre, String instructor,
        ...
        if (instructor == null || instructor.isBlank()) throw new IllegalArgumentException("instructor requerido");
        if (horario    == null)                         throw new IllegalArgumentException("horario requerido");
        if (fecha      == null)                         throw new IllegalArgumentException("fecha requerida");
        if (capacidadMaxima <= 0)                       throw new IllegalArgumentException("capacidad debe ser positiva");
